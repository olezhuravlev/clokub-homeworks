...
resource "yandex_compute_instance" "instance" {
  ...
  # We need connection to automatically copy private key file to VM with public IP and change its permissions.
#  connection {
#    type        = "ssh"
...
#  }
#
#  # Copy respective private key to allow ssh-connection between machines.
#  provisioner "file" {
