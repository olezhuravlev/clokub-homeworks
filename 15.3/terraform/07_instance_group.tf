...
#      user-data : "#!/bin/bash\n currtime=$(date +'%T.%3N'); echo '<html><h1>Happy New Year 2023!</h1><img src=${var.picture_link} height='300'/><h2>'$currtime'</h2></html>' > /var/www/html/index.html\n"
#    }
#
#    network_settings {
#      type = "STANDARD"
...
#
#  load_balancer {
#    target_group_name        = "lamp-instance-target-group"
#    target_group_description = "Network Load Balancer of LAMP instance group"
#  }
#
#  #  application_load_balancer {
#  #    target_group_name        = "lamp-instance-target-group"
#  #    target_group_description = "Application Load Balancer of LAMP instance group"
#  #  }
#}
